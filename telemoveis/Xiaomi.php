    ...
    <div class="container text-center" style="margin-bottom: 150px;">
        <div class="row">
            ...
            <div class="col-md-4"  style="margin-bottom: 50px;">
                <a href="reparacao\tiposreparaçao.php" class="text-decoration-none" style="color: black;">
                    <div class="service-item p-4 " style=" max-width: 500px; max-height: 500px; width:100%; height:100%">
                        <img class="img-fluid mb-1" src="../imagens/xiomimi11ultra.jpg" alt="" style="width: 300px; height: 300px;">
            ...
            <div class="col-md-4"  style="margin-bottom: 50px;">
                <a href="reparacao\tiposreparaçao.php" class="text-decoration-none" style="color: black;">
                    <div class="service-item p-4 " style=" max-width: 500px; max-height: 500px; width:100%; height:100%">
                        <img class="img-fluid mb-1" src="../imagens/xiomimi10ultra.jpg" alt="" style="width: 300px; height: 300px;">
            ...
            <div class="col-md-4"  style="margin-bottom: 50px;">
                <a href="reparacao\tiposreparaçao.php" class="text-decoration-none" style="color: black;">
                    <div class="service-item p-4 " style=" max-width: 500px; max-height: 500px; width:100%; height:100%">
                        <img class="img-fluid mb-1" src="../imagens/redminote12pro.jpg" alt="" style="width: 300px; height: 300px;">
            ...
            <div class="col-md-4"  style="margin-bottom: 50px;">
                <a href="reparacao\tiposreparaçao.php" class="text-decoration-none" style="color: black;">
                    <div class="service-item p-4 " style=" max-width: 500px; max-height: 500px; width:100%; height:100%">
                        <img class="img-fluid mb-1" src="../imagens/redminote13.jpg" alt="" style="width: 300px; height: 300px;">
